        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-emerald-200 text-sm leading-relaxed max-w-md">
              Create stunning, professional portfolios in minutes. Join thousands of creators 
              who trust our platform to showcase their work and land their dream opportunities.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  Home
                </a>
              </li>
              <li>
                <a href="#portfolios" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  Portfolios
                </a>
              </li>
              <li>
                <a href="#uibuilder" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  UI-Builder
                </a>
              </li>
              <li>
                <a href="#aboutus" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  About Us
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#help" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  Help Center
                </a>
              </li>
              <li>
                <a href="#contact" className="text-emerald-200 hover:text-white transition-colors text-sm">
                  Contact Us
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-emerald-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-emerald-200 text-sm">
              <p>&copy; {currentYear} Portfolio Builder. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
